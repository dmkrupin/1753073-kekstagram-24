import {PHOTO_NUMBER, COMMENT_ARRAY, COMMENTATOR_NAME_ARRAY} from '../global-variables.js';
...
const createRandomPhotoDataset = () => {
  ...
  const randomPhotoDataset = {
    id: getRandomIntFromRange(1, PHOTO_NUMBER),
    url: `photos/${getRandomIntFromRange(1, PHOTO_NUMBER)}.jpg`,
    description: `Описание фотографии${getRandomIntFromRange(1, PHOTO_NUMBER)}`,
...
const generatePhotos = (photosNumber) => Array.from({length: photosNumber}, createRandomPhotoDataset);
